...
class CourseOrganization(models.Model):
    ...
    organization_image = models.ImageField(upload_to='apps/organizations/static/organizations/images/organization/%Y/%m',
...
class Teacher(models.Model):
    ...
    collect_number = models.IntegerField(default=0, verbose_name=u'收藏人数')
    click_number = models.IntegerField(default=0, verbose_name=u'点击量')
    teacher_image = models.ImageField(upload_to='apps/organizations/static/organizations/images/teacher/%Y/%m',
